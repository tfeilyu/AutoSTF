...
class LightTransferLayer(nn.Module):
    def __init__(self, hid_dim, dim_feedforward):
        super(LightTransferLayer, self).__init__()
...
class LightTransfer(nn.Module):
    def __init__(self, config):
        super(LightTransfer, self).__init__()
        ...
        for _ in range(self.layers):
            self.LightLayers.append(LightTransferLayer(self.hid_dim, self.hid_dim*4))
