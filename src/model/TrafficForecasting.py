...
from src.model.TransferLayer import MultiLayerPerceptron, LightTransfer
...
class AutoTF(nn.Module):
    def __init__(self, in_length, out_length,
        ...
        if self.IsUseLinear:
            self.light_linear_layer = LightTransfer(config)
